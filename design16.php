...
<div class="card m-1">
    ...
    <h3 class="text-center text-white bg-dark mt-2">IDENTY CARD</h3>
    <div class="text-center mt-3">
    <img src="'.$row["pphoto"].'" alt="Card image cap"  width="160px" height="200px" style="border-radius:5px; border:2px solid green;">
    </div>
