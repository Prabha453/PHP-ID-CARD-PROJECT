...
<div class="card m-1">
    ...
    <h3 class="text-center text-dark mt-2">IDENTY CARD</h3>
    <div class="text-center mt-3">
    <img src="'.$row["pphoto"].'" alt="Card image cap"  width="180px" height="180px" style="border-radius:100px; border:1px solid black;">
    </div>
