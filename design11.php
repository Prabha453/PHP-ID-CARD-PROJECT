...
<div class="card m-1">
    ...
    <h3 class="text-center text-white"><img src="'.$row["orglogo"].'" alt="logo" id="logo" width="40" height="40">    <b>'.$row["orgName"].'</b></h3>
    <small class="text-center text-danger"><b>'.$row["orgAddress"].'</b></small>
    <h6 class="text-center text-primary"><b><pre>Phone:'.$row["orgPhone"].'</pre><b></h6>
    </div>
    <h3 class="text-center text-white mt-2">IDENTY CARD</h3>
    <div class="text-center mt-3">
    <img src="'.$row["pphoto"].'" alt="Card image cap"  width="180px" height="180px" style="border-radius:200px; border:1px solid white;">
    </div>
