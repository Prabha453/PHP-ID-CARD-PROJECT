...
.card
{
  background-image: url('IMAGES/designn-1.jpg');
...
<div class="card m-1">
    ...
    <img src="'.$row["pphoto"].'" alt="Card image cap"  width="150px" height="200px" style="border-radius:10px; border:3px solid red;">
    </div>
    <div class="card-body text-center">
      <h3 class="card-title text-white">'.$row["pname"].'</h3>
      <p class="card-text text-white">'.$row["pposition"].'</p>
      </div>
